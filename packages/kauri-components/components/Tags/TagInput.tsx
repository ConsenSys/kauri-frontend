      ...
      <Wrapper>
        <div>
          <TopRow>
            ...
            <Input
              data-testid={
                (this.props.prefixTestId &&
                  this.props.prefixTestId("tag-input")) ||
                "tag-input"
              }
        ...
        {this.state.value.length > 0 && (
          <Results>
            ...
            {!available ||
              (available.filter(i => i.tag === this.state.value).length ===
                0 && (
                <Result
                  className={
                    !available || this.state.selectedIndex >= available.length
                      ? "selected"
                      : ""
                  }
