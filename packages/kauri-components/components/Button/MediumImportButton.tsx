...
const SVG = <Icon viewBox="0 0 24 24">
...
const MediumImportButton = (props: IProps) => <a target="_blank" href="https://import.beta.kauri.io">
    { props.border ? 
    <SecondaryButton border="primary" color="textPrimary">{SVG}Medium Import</SecondaryButton> :
