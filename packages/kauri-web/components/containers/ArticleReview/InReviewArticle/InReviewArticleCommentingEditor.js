...
const BlockWrapper = (props: any) => {
  ...
  return redraft(
    raw,
    { inline: inline, blocks: blocks(true, false, false, true), entities },
    options
  );
};
...
export default class InReviewArticleCommentingEditor extends React.Component<
  Props,
  State
> {
  componentDidMount() {
