...
export type getCollection_getCollection_sections_resources_CollectionDTO_owner =
  | getCollection_getCollection_sections_resources_CollectionDTO_owner_ArticleDTO
  | getCollection_getCollection_sections_resources_CollectionDTO_owner_PublicUserDTO
...
export type getCollection_getCollection_sections_resources_CollectionDTO_sections_resources =
  | getCollection_getCollection_sections_resources_CollectionDTO_sections_resources_CommunityDTO
  | getCollection_getCollection_sections_resources_CollectionDTO_sections_resources_ArticleDTO;
...
export interface getCollection_getCollection_sections_resources_CollectionDTO_sections {
  ...
  resourcesId:
    ...
    | null;
  resources:
    | (getCollection_getCollection_sections_resources_CollectionDTO_sections_resources | null)[]
    | null;
}
